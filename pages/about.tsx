  ...
  return (
    <div className="about">
      ...
      <p className="about__text">
        ...
        series like rates, date, story etc. Also you can watch trailer. You can
        search your favorite movie, TV series and actors. At the bottom of the
        page you can see the movies and TV series that you have visited before.
      </p>
    </div>
  );
}
